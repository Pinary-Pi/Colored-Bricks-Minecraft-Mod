...
public class ModBlocks {
    ...
    public static final RegistryObject<StairsBlock> WHITE_BRICK_STAIRS = register("white_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_WHITE));
    public static final RegistryObject<StairsBlock> ORANGE_BRICK_STAIRS = register("orange_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_ORANGE));
    public static final RegistryObject<StairsBlock> PINK_BRICK_STAIRS = register("pink_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_PINK));
    public static final RegistryObject<StairsBlock> YELLOW_BRICK_STAIRS = register("yellow_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_YELLOW));
    public static final RegistryObject<StairsBlock> LIME_BRICK_STAIRS = register("lime_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_LIME));
    public static final RegistryObject<StairsBlock> GREEN_BRICK_STAIRS = register("green_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_GREEN));
    public static final RegistryObject<StairsBlock> LIGHT_BLUE_BRICK_STAIRS = register("light_blue_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_LIGHT_BLUE));
    public static final RegistryObject<StairsBlock> CYAN_BRICK_STAIRS = register("cyan_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CYAN));
    public static final RegistryObject<StairsBlock> BLUE_BRICK_STAIRS = register("blue_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_BLUE));
    public static final RegistryObject<StairsBlock> MAGENTA_BRICK_STAIRS = register("magenta_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_MAGENTA));
    public static final RegistryObject<StairsBlock> PURPLE_BRICK_STAIRS = register("purple_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_PURPLE));
    public static final RegistryObject<StairsBlock> BROWN_BRICK_STAIRS = register("brown_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_BROWN));
    public static final RegistryObject<StairsBlock> LIGHT_GRAY_BRICK_STAIRS = register("light_gray_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_LIGHT_GRAY));
    public static final RegistryObject<StairsBlock> GRAY_BRICK_STAIRS = register("gray_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_GRAY));
    public static final RegistryObject<StairsBlock> BLACK_BRICK_STAIRS = register("black_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_BLACK));
    public static final RegistryObject<StairsBlock> RED_BRICK_STAIRS = register("red_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_RED));
    ...
    public static final RegistryObject<StairsBlock> CRACKED_BRICK_STAIRS = register("cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED));
    public static final RegistryObject<StairsBlock> WHITE_CRACKED_BRICK_STAIRS = register("white_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_WHITE));
    public static final RegistryObject<StairsBlock> ORANGE_CRACKED_BRICK_STAIRS = register("orange_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_ORANGE));
    public static final RegistryObject<StairsBlock> PINK_CRACKED_BRICK_STAIRS = register("pink_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_PINK));
    public static final RegistryObject<StairsBlock> YELLOW_CRACKED_BRICK_STAIRS = register("yellow_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_YELLOW));
    public static final RegistryObject<StairsBlock> LIME_CRACKED_BRICK_STAIRS = register("lime_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_LIME));
    public static final RegistryObject<StairsBlock> GREEN_CRACKED_BRICK_STAIRS = register("green_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_GREEN));
    public static final RegistryObject<StairsBlock> LIGHT_BLUE_CRACKED_BRICK_STAIRS = register("light_blue_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_LIGHT_BLUE));
    public static final RegistryObject<StairsBlock> CYAN_CRACKED_BRICK_STAIRS = register("cyan_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_CYAN));
    public static final RegistryObject<StairsBlock> BLUE_CRACKED_BRICK_STAIRS = register("blue_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_BLUE));
    public static final RegistryObject<StairsBlock> MAGENTA_CRACKED_BRICK_STAIRS = register("magenta_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_MAGENTA));
    public static final RegistryObject<StairsBlock> PURPLE_CRACKED_BRICK_STAIRS = register("purple_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_PURPLE));
    public static final RegistryObject<StairsBlock> BROWN_CRACKED_BRICK_STAIRS = register("brown_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_BROWN));
    public static final RegistryObject<StairsBlock> LIGHT_GRAY_CRACKED_BRICK_STAIRS = register("light_gray_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_LIGHT_GRAY));
    public static final RegistryObject<StairsBlock> GRAY_CRACKED_BRICK_STAIRS = register("gray_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_GRAY));
    public static final RegistryObject<StairsBlock> BLACK_CRACKED_BRICK_STAIRS = register("black_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_BLACK));
    public static final RegistryObject<StairsBlock> RED_CRACKED_BRICK_STAIRS = register("red_cracked_brick_stairs", () -> getStairsBrick(STAIR_BLOCKSTATE_CRACKED_RED));
    ...
    private static Block getBlockBrick() {
        return new Block(AbstractBlock.Properties.create(Material.ROCK)
    ...
    private static StairsBlock getStairsBrick(Supplier<BlockState> state) {
        return new StairsBlock(state, AbstractBlock.Properties.create(Material.ROCK)
                .hardnessAndResistance(2, 6)
                .sound(SoundType.STONE)
                .harvestLevel(0)
                .harvestTool(ToolType.PICKAXE)
    ...
    private static SlabBlock getSlabBrick() {
        return new SlabBlock(AbstractBlock.Properties.create(Material.ROCK)
                .hardnessAndResistance(2, 6)
                .sound(SoundType.STONE)
                .harvestLevel(0)
                .harvestTool(ToolType.PICKAXE)
    ...
    private static WallBlock getWallBrick() {
        return new WallBlock(AbstractBlock.Properties.create(Material.ROCK)
                .hardnessAndResistance(2, 6)
                .sound(SoundType.STONE)
                .harvestLevel(0)
                .harvestTool(ToolType.PICKAXE)
    ...
    private static <T extends Block> RegistryObject<T> register(String name, Supplier<T> block, ItemGroup tab) {
        ...
        Registration.ITEMS.register(name, () -> new BlockItem(ret.get(), new Item.Properties().group(tab)));
        return ret;
    }
