...
public class ModBlocks {
    ...
    public static final Block WHITE_BRICK_STAIRS = registerBrickBlock("white_brick_stairs", new StairsBlock(ModBlocks.WHITE_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block ORANGE_BRICK_STAIRS = registerBrickBlock("orange_brick_stairs", new StairsBlock(ModBlocks.ORANGE_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block PINK_BRICK_STAIRS = registerBrickBlock("pink_brick_stairs", new StairsBlock(ModBlocks.PINK_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block YELLOW_BRICK_STAIRS = registerBrickBlock("yellow_brick_stairs", new StairsBlock(ModBlocks.YELLOW_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block LIME_BRICK_STAIRS = registerBrickBlock("lime_brick_stairs", new StairsBlock(ModBlocks.LIME_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block GREEN_BRICK_STAIRS = registerBrickBlock("green_brick_stairs", new StairsBlock(ModBlocks.GREEN_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block LIGHT_BLUE_BRICK_STAIRS = registerBrickBlock("light_blue_brick_stairs", new StairsBlock(ModBlocks.LIGHT_BLUE_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block CYAN_BRICK_STAIRS = registerBrickBlock("cyan_brick_stairs", new StairsBlock(ModBlocks.CYAN_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block BLUE_BRICK_STAIRS = registerBrickBlock("blue_brick_stairs", new StairsBlock(ModBlocks.BLUE_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block MAGENTA_BRICK_STAIRS = registerBrickBlock("magenta_brick_stairs", new StairsBlock(ModBlocks.MAGENTA_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block PURPLE_BRICK_STAIRS = registerBrickBlock("purple_brick_stairs", new StairsBlock(ModBlocks.PURPLE_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block BROWN_BRICK_STAIRS = registerBrickBlock("brown_brick_stairs", new StairsBlock(ModBlocks.BROWN_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block LIGHT_GRAY_BRICK_STAIRS = registerBrickBlock("light_gray_brick_stairs", new StairsBlock(ModBlocks.LIGHT_GRAY_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block GRAY_BRICK_STAIRS = registerBrickBlock("gray_brick_stairs", new StairsBlock(ModBlocks.GRAY_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block BLACK_BRICK_STAIRS = registerBrickBlock("black_brick_stairs", new StairsBlock(ModBlocks.BLACK_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block RED_BRICK_STAIRS = registerBrickBlock("red_brick_stairs", new StairsBlock(ModBlocks.RED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    ...
    public static final Block CRACKED_BRICK_STAIRS = registerBrickBlock("cracked_brick_stairs", new StairsBlock(CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block WHITE_CRACKED_BRICK_STAIRS = registerBrickBlock("white_cracked_brick_stairs", new StairsBlock(ModBlocks.WHITE_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block ORANGE_CRACKED_BRICK_STAIRS = registerBrickBlock("orange_cracked_brick_stairs", new StairsBlock(ModBlocks.ORANGE_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block PINK_CRACKED_BRICK_STAIRS = registerBrickBlock("pink_cracked_brick_stairs", new StairsBlock(ModBlocks.PINK_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block YELLOW_CRACKED_BRICK_STAIRS = registerBrickBlock("yellow_cracked_brick_stairs", new StairsBlock(ModBlocks.YELLOW_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block LIME_CRACKED_BRICK_STAIRS = registerBrickBlock("lime_cracked_brick_stairs", new StairsBlock(ModBlocks.LIME_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block GREEN_CRACKED_BRICK_STAIRS = registerBrickBlock("green_cracked_brick_stairs", new StairsBlock(ModBlocks.GREEN_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block LIGHT_BLUE_CRACKED_BRICK_STAIRS = registerBrickBlock("light_blue_cracked_brick_stairs", new StairsBlock(ModBlocks.LIGHT_BLUE_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block CYAN_CRACKED_BRICK_STAIRS = registerBrickBlock("cyan_cracked_brick_stairs", new StairsBlock(ModBlocks.CYAN_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block BLUE_CRACKED_BRICK_STAIRS = registerBrickBlock("blue_cracked_brick_stairs", new StairsBlock(ModBlocks.BLUE_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block MAGENTA_CRACKED_BRICK_STAIRS = registerBrickBlock("magenta_cracked_brick_stairs", new StairsBlock(ModBlocks.MAGENTA_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block PURPLE_CRACKED_BRICK_STAIRS = registerBrickBlock("purple_cracked_brick_stairs", new StairsBlock(ModBlocks.PURPLE_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block BROWN_CRACKED_BRICK_STAIRS = registerBrickBlock("brown_cracked_brick_stairs", new StairsBlock(ModBlocks.BROWN_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block LIGHT_GRAY_CRACKED_BRICK_STAIRS = registerBrickBlock("light_gray_cracked_brick_stairs", new StairsBlock(ModBlocks.LIGHT_GRAY_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block GRAY_CRACKED_BRICK_STAIRS = registerBrickBlock("gray_cracked_brick_stairs", new StairsBlock(ModBlocks.GRAY_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block BLACK_CRACKED_BRICK_STAIRS = registerBrickBlock("black_cracked_brick_stairs", new StairsBlock(ModBlocks.BLACK_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
    public static final Block RED_CRACKED_BRICK_STAIRS = registerBrickBlock("red_cracked_brick_stairs", new StairsBlock(ModBlocks.RED_CRACKED_BRICKS.getDefaultState(), BRICK_SETTINGS), BUILDING_BLOCKS);
